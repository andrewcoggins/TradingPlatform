...
public class OrderTest {
  ...
  public void testOrder() {
    ...
    assertEquals(anOrder.toTransaction(), new Transaction(0, 1, 100.0, 6, new Tradeable(0)));
    assertEquals(anOrder.updatePrice(90.0), new Order(0, 1, 90.0, 6, new Tradeable(0)));
    assertEquals(anOrder.updateToAgent(5), new Order(5, 1, 100.0, 6, new Tradeable(0)));
  }
}
