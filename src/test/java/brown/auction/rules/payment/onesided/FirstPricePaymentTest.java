...
import brown.auction.rules.payment.FirstPricePayment;
...
public class FirstPricePaymentTest {

  // single item case
  @Test
  public void testFirstPricePayemnt() {
    ...
    IPaymentRule pRule = new FirstPricePayment();
    ...
    IAccountUpdate expected = new AccountUpdate(9, 9.0, expectedCart);
  ...
  @Test
  public void testFirstPricePaymentTwo() {
    ...
    for (int i = 0; i < NUMITEMS; i++) {
      ...
      IAccountUpdate expected = new AccountUpdate(9, 9.0 - i, expectedCart);
