...
public class UtilityManagerTest {
  ...
  public void testUtilityManager() {
    ...
    Map<List<IItem>, ISpecificValuation> valOne = new HashMap<List<IItem>, ISpecificValuation>(); 
    Map<List<IItem>, ISpecificValuation> valTwo = new HashMap<List<IItem>, ISpecificValuation>();
    ...
    IValuationDistribution valDist = new AdditiveValuationDistribution(new Cart(agentItems), gen); 
