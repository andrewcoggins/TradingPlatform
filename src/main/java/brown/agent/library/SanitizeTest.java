...
public class SanitizeTest extends AbsPredictionMarketAgent {
  ...
  public SanitizeTest(String host, int port, double price, boolean print) throws AgentCreationException {
    super(host, port);
    this.price = price;
    this.print = print;
  }
  
  public SanitizeTest(String host, int port, String name, double price, boolean print) throws AgentCreationException {
  ...
  public static void main(String[] args) throws AgentCreationException {
    new SanitizeTest("localhost", 2121, "buy1", 1, false);
    new SanitizeTest("localhost", 2121, "buy20", 20, false);
    new SanitizeTest("localhost", 2121, "buy40", 40, false);
    new SanitizeTest("localhost", 2121, "buy60", 60, true);
